...
class Zipmoney_ZipmoneyPayment_Model_Pay extends Mage_Payment_Model_Method_Abstract
{
    protected $helper;
    protected $logger;
    //Zipmenoney_ZipmoneyPayment_Model_Api
    protected $api = null;
     ...
     *
     * @return Zipmenoney_ZipmoneyPayment_Model_Api
     */
