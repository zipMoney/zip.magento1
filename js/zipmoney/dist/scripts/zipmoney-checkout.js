...
zipCheckout.prototype = {
                           ...
                           this.saveUrl,
                           {
                             ...
                             onSuccess: function(transport){
                              console.log(2222);
                                ...
                                //_this.onSuccess(transport,_payment)
                             },
  ...
  onSuccess: function(transport,_payment) {
   ...
   this.redirectZip(transport,_payment);
  ...
  redirectZip:function(transport, _payment){
    ...
    Zip.Checkout.init({
      redirect: false,
      checkoutUri: "http://local.zipmoney.com.au/magento-ce-1.9.2.2/zipmoneypayment/standard/",
      redirectUri: "http://local.zipmoney.com.au/magento-ce-1.9.2.2/zipmoneypayment/complete/",
      onComplete: function(response){
        ...
        if(response.state == "approved"){
          ...
          location.href = "http://local.zipmoney.com.au/magento-ce-1.9.2.2/zipmoneypayment/complete/?result=referred&checkoutId="+response.checkoutId;
        }
